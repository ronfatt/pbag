...
> = {
  ...
  "Computer Literacy": {
    category: "Digital",
    image: "/images/computer-class.jpg",
  ...
  "Life Skills": {
    category: "Skills",
    image: "/images/baking-volunteers.jpg",
  ...
  "Culinary Skills": {
    category: "Skills",
    image: "/images/culinary-class.jpg",
  ...
  return (
    <section id="programs" className="bg-[#fffaf0] py-24">
      <div className="section-shell">
        ...
        <SectionReveal className="mt-9 flex gap-3 overflow-x-auto pb-2">
